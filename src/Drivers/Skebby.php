...
use Inforisorse\SmsGateway\Traits\UseCurlForApi;
...
class Skebby extends AbstractSmsDriver implements SmsDriverInterface
{
    ...
    /**
     * Returns the necessary request headers for authentication
     *
     * @return string[]
     */
    ...
    {
        return [
            $this->makeHeader(self::HEADER_USER_KEY, $this->getUserKey()),
            $this->makeHeader(self::HEADER_TOKEN_NAME, $this->getAccessToken()),
        ];
    }
